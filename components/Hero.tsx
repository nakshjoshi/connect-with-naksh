...
function Hero() {
  ...
  function openResume(){
    window.open('https://drive.google.com/file/d/1imBR6LvURagGtJFWQzUHqutZG0rJVyo_/view?usp=drive_link', '_blank')
  }
  return (
    <>
    ...
    <div className="min-h-screen bg-background flex items-center px-4 md:px-6 lg:px-24 py-16 lg:py-24 font-fira" id="home">
      ...
      <div className="w-full flex flex-col lg:flex-row items-center justify-between max-w-6xl mx-auto gap-8 lg:gap-12">
        ...
        <div className="w-full lg:w-1/2 relative flex justify-center order-first lg:order-last">
          ...
          {/* Badges */}
          <div className="absolute -bottom-8 lg:-bottom-6 left-1/2 -translate-x-1/2 flex flex-col gap-2 w-[280px] sm:w-auto z-20">
            <div className="bg-background border border-gray px-2 lg:px-3 py-1 lg:py-2 flex items-center justify-center gap-2 text-gray text-xs lg:text-sm font-fira">
            ...
            <div className="bg-background border border-gray px-2 lg:px-3 py-1 lg:py-2 flex items-center justify-center gap-2 text-gray text-xs lg:text-sm font-fira">
              <span className="text-primary font-medium">SDE Intern</span>
              <span className="truncate">@ CargoFL</span>
            </div>
          </div>
